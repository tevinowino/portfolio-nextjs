...
import { Github, ArrowRight, ExternalLink, Star, Code, Calendar } from 'lucide-react';
              ...
              <div className="flex items-center gap-4">
                ...
                {project.demo && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-teal-400 hover:text-teal-300 transition-all group/link"
                  >
